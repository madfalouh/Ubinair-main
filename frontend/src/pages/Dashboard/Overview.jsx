...
export default function Overview({ indexPage }) {
    ...
    useEffect(() => {
        console.log("fguiiufiugfiugdfpiugdfughufgdiuupidfgpiufghdpgqpdfgpsidfgpsdfgposdfgjidfgspojdfgpopoisdfgjpoisdfgpoifsdgijpodfgjpoidfgpoij");
    ...
    return (
        <>
            ...
            { projectDetails.specification?.length === 0 ? (
                ...
                >
                    <top className="flex  items-center justify-center gap-7 h-[272px]  ml-80 ">
                    ...
                    {loadingProjectDetails ? (
                        ...
                        <bottom className="flex items-start justify-start gap-12 ml-80">
                            <div style={{ width: 710, height: 500 }}>
                                <ViewSwitcher
                                    ...
                                    isChecked={isChecked}
                                />
                                <div className="bg-white shadow-md  p-2 rounded-xl ml-10">
                                    <Gantt
